...
# ZDE ÚKOL - SEZNAM BALÍKŮ PODRUHÉ
...
for package in package_list:
    if hasattr(package, 'value') and package.state == "nedoručen": # dopsání logického operátoru and a připsání další podmínky na zkontrolování stavu
